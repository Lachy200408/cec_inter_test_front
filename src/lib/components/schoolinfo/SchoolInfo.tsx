...
export default function SchoolInfo() {
  return (
    <article
      className={cn(
        'h-180 bg-app-yellow-500/15 rounded-xl p-2 w-[min(1280px,100%)] overflow-x-auto scroll-soft',
        montserratFont.className
      )}
    >
      <div className="px-12 py-20 w-320 h-full grid grid-cols-4 grid-rows-3 gap-8 ">
        <div className="col-span-2 row-span-2 grid grid-cols-2 grid-rows-[repeat(2,auto)]">
          <div className="col-span-2 flex flex-col gap-8">
            <h3 className="max-w-lg max-md:text-4xl">
              ¿Qué puedes esperar al estudiar en un programa de CEC?
              <RectDecorator className="mt-3 w-16 bg-app-yellow-500" />
            </h3>
            <h5 className="text-app-gray font-light max-md:text-2xl">
          ...
          <div className="col-span-2 grid grid-cols-2 grid-rows-[repeat(2,auto)] grid-flow-col gap-x-8">
            <SchoolInfoItem head="Educación de calidad">
              Los programas de CEC están diseñados por expertos en la materia, asegurando que
              recibas una formación de alta calidad y actualizada.
            </SchoolInfoItem>
        ...
        <figure className="col-span-2 row-span-2 grid place-items-end relative">
          <Image
            ...
            width={1060}
            height={807}
            className="w-[504px] absolute bottom-6 right-8 z-10"
          />
